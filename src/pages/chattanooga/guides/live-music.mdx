...
neighborhoods: ["Downtown", "St. Elmo", "North Shore", "East Ridge", "Ooltewah", "Arts District"]
seasonality: "Year-round; outdoor concerts peak summer (May-October), festivals fall-spring"
bestFor: ["Music lovers", "Date night", "Families", "Festival-goers", "Nightlife seekers"]
images: [
    {src: "/images/chattanooga_guides/live-music/woodshop1.webp", position: "upper"},
  ...
  <section class="text-xl">
    ...
    <div class="pb-3">
      <div class="pb-5">
        ...
        <div class="pb-10">
          For even more on history in Chattanooga, take a look at our guide on the American civil war in this city <a href="/chattanooga/guides/civil-war-history" target="_blank">here</a>.
        </div>
      </div>
    </div>
  </section>
