...
<div>
  <div class="pb-2 text-2xl">
    <div class="flex flex-col justify-center items-center mb-16 mt-16">
      <OptimizedImage loading="eager" src="/images/chattanooga_guides/live-music/woodshop1.webp" alt="the woodshop" />
  ...
  <div class="flex flex-col justify-center items-center mb-16 mt-16">
    <OptimizedImage src="/images/chattanooga_guides/live-music/woodshop2.webp" alt="the woodshop exterior" />
  </div>
