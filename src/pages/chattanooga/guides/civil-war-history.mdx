...
<div>
  <div class="pb-2 text-2xl">
    <div class="flex flex-col justify-center items-center mb-16 mt-16">
      <OptimizedImage src="/images/chattanooga_guides/history/soldiers_with_flag.jpg" alt="soldiers with flag monument" />
    ...
    <div class="flex flex-col justify-center items-center mb-16 mt-16">
      <OptimizedImage src="/images/chattanooga_guides/history/monument_tennessee.jpg" alt="chick battlefield monument" />
      <div class="text-center">
 ...
 <section class="pb-5 pt-6 text-2xl">
  ...
  <div class="flex flex-col justify-center items-center mb-16 mt-16">
    <OptimizedImage src="/images/chattanooga_guides/history/path.jpg" alt="civil war park path" />
    <div class="text-center">
  ...
  <section class="pb-3 text-xl2">
    ...
    <div>
      <div>
        ...
        <div class="flex flex-col justify-center items-center mb-16 mt-16">
          <OptimizedImage src="/images/chattanooga_guides/history/forest_hills_cemetery.jpg" alt="forest hills cemetery" />
          <div class="text-center">
  ...
  <div class="flex flex-col justify-center items-center mb-16 mt-16">
      <OptimizedImage src="/images/chattanooga_guides/history/war_canons.jpg" alt="war cannons" />
      <div class="text-center">
