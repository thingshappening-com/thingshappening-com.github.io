...
<div>
  <div class="pb-2 text-2xl">
    <div class="flex flex-col justify-center items-center mb-16 mt-16">
      <OptimizedImage loading="eager" src="/images/chattanooga_guides/history/soldiers_with_flag.webp" alt="Monument of two soldiers raising a flag at Chickamauga Battlefield" />
