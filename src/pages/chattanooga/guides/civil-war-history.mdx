  ...
  <section class="pb-3 text-xl2">
    ...
    <div>
      <div>
        ...
        <div class="flex flex-col justify-center items-center mb-16 mt-16">
          <OptimizedImage src="/images/chattanooga_guides/history/forest_hills_cemetery.webp" alt="Cemetery initially dedicated to Civil War casualities and their families" />
          <div class="text-center">
