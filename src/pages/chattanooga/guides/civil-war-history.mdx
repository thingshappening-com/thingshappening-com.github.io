...
<div>
  <div class="pb-2 text-2xl">
    <div class="flex flex-col justify-center items-center mb-16 pt-10">
    ...
    <section class="text-2xl" id="chickamauga">
      <div class="pb-5">
    ...
    <section class="text-2xl" id="chattanooga-campaign">
      <div class="pb-6">
 ...
 <section class="pb-5 pt-6 text-2xl">
  <div>
    <p>
  ...
  <section class="pb-3 text-2xl" id="military-park">
    <div class="pb-1">
  ...
  <section class="pb-3 text-xl2" id="smaller-sites">
    <div>
