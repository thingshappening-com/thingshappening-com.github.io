...
neighborhoods: ["Rising Fawn, GA", "Lookout Mountain", "Cloudland Canyon"]
seasonality: "Year-round; best weather March-November, waterfalls peak after rainfall"
bestFor: ["Hikers", "Mountain bikers", "Families", "Campers", "Nature lovers"]
images: [
    {src: "/images/chattanooga_guides/outdoors/cloudland/vista.webp", position: "center"},
    {src: "/images/chattanooga_guides/outdoors/cloudland/trail-shot.webp", position: "lower"},
    {src: "/images/chattanooga_guides/outdoors/cloudland/overlook-west-rim.webp", position: "center"}
  ]
# sources: ["Georgia State Parks", "Cloudland Canyon State Park", "AllTrails", "Friends of Cloudland Canyon"]
---
import OptimizedImage from '../../../components/OptimizedImage.astro';

<div>
  <div class="pb-5">
    <a href="/pdfs/chattanooga/cloudland-canyon.pdf" target="_blank" class="inline-flex items-center px-4 py-2 bg-logoDarkGreen text-logoLightGreen rounded-lg hover:opacity-90 transition-colors">
  ...
  <div class="pb-2 text-xl pt-6">
    ...
    <div class="text-xl pb-5">
       The park offers numerous activities suitable for the whole family, whether for a day trip or a weekend getaway. In this guide let's take a look at more of what this nearby trail system treasure has to offer.
    </div>
    ...
    <div class="mb-12 mt-12 flex flex-col justify-center items-center">
      <OptimizedImage  src="/images/chattanooga_guides/outdoors/cloudland/vista.webp" alt="Overlook view of Cloudland Canyon State Park" />
      <div class="text-center mt-4 text-[20px] max-w-2xl text-gray-600">
        <em>Cloudland Canyon Overlook Vista</em>
      </div>
    </div>
    ...
    <section class="text-xl pb-12">
      <div>
        ...
        <div class="pb-4">
          <div class="text-xl">
            <div class="pb-4"><a class="text-3xl gradient-text" href="#easier-hikes">Easier Hikes</a></div>
            <div class="pb-4"><a class="text-3xl gradient-text" href="#mtb-easy">Easier MTB Rides</a></div>
            <div class="pb-4"><a class="text-3xl gradient-text" href="#advanced-hikes">Intermediate/Advanced Hikes</a></div>
            <div class="pb-4"><a class="text-3xl gradient-text" href="#mtb-advanced">Intermediate/Advanced MTB</a></div>
            <div class="pb-4"><a class="text-3xl gradient-text" href="#disc-golf">Disc Golf</a></div>
            <div class="pb-4"><a class="text-3xl gradient-text" href="#camping">Camping</a></div>
            <div class="pb-4"><a class="text-3xl gradient-text" href="#fishing">Fishing</a></div>
            <div class="pb-4"><a class="text-3xl gradient-text" href="#eating">Eating Nearby</a></div>
          </div>
        </div>
      </div>
    </section>

    <section class="pb-3 text-xl" id="easier-hikes">
      <div class="pb-3">
        <h2 class="text-5xl" style="font-family: 'Libre Baskerville', serif;">Easier Hikes<span class="color-pink ml-1"><b>.</b></span></h2>
      </div>
      <div>
    ...
    <div class="mb-12 mt-12 flex flex-col justify-center items-center">
      <OptimizedImage src="/images/chattanooga_guides/outdoors/cloudland/trail-shot.webp" alt="West Rim and Overlook trails fork in Cloudland Canyon" />
      <div class="text-center mt-4 text-[20px] max-w-2xl text-gray-600">
        <em>On the trail in CCSP</em>
      </div>
    </div>

    <section class="pb-3 text-xl" id="mtb-easy">
      <div>
        <h2 class="text-5xl" style="font-family: 'Libre Baskerville', serif;">Easier MTB Rides<span class="color-pink ml-1"><b>.</b></span></h2>
      </div>
      <div class="pb-5">
    ...
    <div class="mb-12 mt-12 flex flex-col justify-center items-center">
      <OptimizedImage src="/images/chattanooga_guides/outdoors/cloudland/mtb-map.webp" alt="5 Points Cloudland Trail Map for Mountain Biking" />
      <div class="text-center mt-4 text-[20px] max-w-2xl text-gray-600">
        <em>5 Points MTB Trail Map</em>
      </div>
    </div>

    <section class="pb-10 text-xl" id="advanced-hikes">
      <div>
        <h2 class="text-5xl w-full break-words" style="font-family: 'Libre Baskerville', serif;">Intermediate/Advanced Hikes<span class="color-pink ml-1"><b>.</b></span></h2>
      </div>
      <div class="pb-5">
        <div class="pb-3">
    ...
    <div class="mb-12 mt-12 flex flex-col justify-center items-center">
        <OptimizedImage src="/images/chattanooga_guides/outdoors/cloudland/overlook-west-rim.webp" alt="Close up of trail signs in the Cloudland Canyon State Park" />
        <div class="text-center mt-4 text-[20px] max-w-2xl text-gray-600">
          <em>Cloudland Canyon Trail Signs</em>
        </div>
    </div>

    <section class="pb-12 text-xl" id="mtb-advanced">
      <div>
        <h2 class="text-5xl w-full break-words" style="font-family: 'Libre Baskerville', serif;">Intermediate/Advanced MTB Rides<span class="color-pink ml-1"><b>.</b></span></h2>
      </div>
      <div>
        <div class="pb-3">
    ...
    <section>
      <div>
        <h2 class="text-5xl w-full break-words" style="font-family: 'Libre Baskerville', serif;">Hiking Breakdown<span class="color-pink ml-1"><b>.</b></span></h2>
      </div>
    ...
    <section>
      <div>
        <h2 class="text-5xl w-full break-words" style="font-family: 'Libre Baskerville', serif;">MTB Breakdown<span class="color-pink ml-1"><b>.</b></span></h2>
      </div>
      <table class="w-full border-collapse border border-gray-300 shadow-md rounded-lg overflow-hidden">
        <thead>
          <tr class="bg-gray-100 text-gray-700 text-left uppercase text-sm">
    ...
    <section class="pb-3 text-xl" id="disc-golf">
      <div>
        <h2 class="text-5xl w-full break-words" style="font-family: 'Libre Baskerville', serif;">Disc Golf<span class="color-pink ml-1"><b>.</b></span></h2>
      </div>
      <div>
    ...
    <div class="mb-12 mt-12 flex flex-col justify-center items-center">
      <OptimizedImage src="https://upload.wikimedia.org/wikipedia/commons/1/1b/Creekside_Disc_Golf_-_1023296199.jpg" alt="disc golf and hole target" />
      <div class="text-center mt-4 text-[20px] max-w-2xl text-gray-600">
        <em>
    ...
    <section class="pb-3 text-xl" id="camping">
      <div>
        <h2 class="text-5xl w-full break-words" style="font-family: 'Libre Baskerville', serif;">Camping<span class="color-pink ml-1"><b>.</b></span></h2>
      </div>
      <div class="mb-5">
    ...
    <div class="mb-12 mt-12 flex flex-col justify-center items-center">
      <OptimizedImage src="https://upload.wikimedia.org/wikipedia/commons/6/67/Series_of_Glamping_Yurts_near_Llansantffraed-in-Elwel%2C_Powys.jpg" alt="Yurt campground atop green hills" />
      <div class="text-center mt-4 text-[20px] max-w-2xl text-gray-600">
        <em>
    ...
    <section class="pb-3 text-xl" id="fishing">
      <div>
        <h2 class="text-5xl w-full break-words" style="font-family: 'Libre Baskerville', serif;">Fishing<span class="color-pink ml-1"><b>.</b></span></h2>
      </div>
      <div class="pb-5">
    ...
    <section class="pb-3 text-xl" id="eating">
      <div>
        <h2 class="text-5xl w-full break-words" style="font-family: 'Libre Baskerville', serif;">Eating Nearby<span class="color-pink ml-1"><b>.</b></span></h2>
      </div>
      <div class="pb-5">
    ...
    <div class="mb-12 mt-12 flex flex-col justify-center items-center">
      <OptimizedImage src="https://upload.wikimedia.org/wikipedia/commons/e/ec/Cloudland_Canyon_State_Park_%288648810088%29.jpg" alt="Cloudland Canyon waterfall" />
      <div class="text-center mt-4 text-[20px] max-w-2xl text-gray-600">
        <em>
    ...
    <section class="pb-3 text-xl">
      <div>
        <h2 class="text-5xl w-full break-words" style="font-family: 'Libre Baskerville', serif;">Other Ideas / Notes of Interest<span class="color-pink ml-1"><b>.</b></span></h2>
      </div>
      <div>
        <div>
          <div class="mb-3">
            <span class="text-2xl"><b>Road Bike</b></span>
            <span class="text-customGreen1 text-4xl font-bold">. </span> The various park areas are mostly interconnected through low-medium trafficked roads depending on when you visit. It can be a great place to ride your bike around nature, get some exercise, and potentially see some wildlife if you're lucky.
          </div>
          <div class="mb-3">
            <span class="text-2xl"><b>Horseback Ride</b></span>
            <span class="text-customGreen1 text-4xl font-bold">. </span> There are some trails in the park that allow for horseback riding. You have to BYO horse, no guided tours are provided by the park. Riding trails are at the 5 Points Recreation Area with parking at <a href="https://www.google.com/maps/place/Ascalon+Trailhead/@34.836966,-85.4412667,17z/data=!3m1!4b1!4m6!3m5!1s0x8860489de9aa9e81:0xaa78f71a6429baa9!8m2!3d34.8369616!4d-85.4386864!16s%2Fg%2F11cjhz867p?entry=ttu&g_ep=EgoyMDI0MDkwNC4wIKXMDSoASAFQAw%3D%3D" target="_blank">Ascalon Trailhead</a>.
          </div>
          <div class="mb-3">
            <span class="text-2xl"><b>Picnic</b></span>
            <span class="text-customGreen1 text-4xl font-bold">. </span> Some free access picnic tables are scattered throughout the park, but you can also rent a larger picnic table for an event or family function. Find availability <a href="https://gastateparks.reserveamerica.com/campsiteFilterAction.do?sitefilter=Picnic%20Shelter&startIdx=0&contractCode=GA&parkId=530148&_gl=1*178u764*_ga*OTUyMDE4MTMyLjE3MjUyMDUzNzU.*_ga_NY38CG84RB*MTcyNTczMTk2OC44LjAuMTcyNTczMTk2OC4wLjAuMA.." target="_blank">here</a>.
          </div>
          <div class="mb-3">
    ...
    <section>
      ...
      <div class="pb-5">
        Looking for more outdoor adventures closer to Chattanooga? Check out our <a href="/chattanooga/guides/outdoors" target="_blank">Chattanooga Outdoors Guide</a> with 71 hiking, biking, and paddling routes. For first-person accounts, try the <a href="/chattanooga/editorials/guild-hardy-trail-lookout-mountain">Guild-Hardy Trail from St. Elmo to Lookout Mountain</a> or <a href="/chattanooga/editorials/shoreline-hike-at-booker-t-washington-state-park">Finding a Shoreline at Booker T. Washington State Park</a>.
      </div>
    </section>
    ...
    <section class="text-xl pt-10">
      ...
      <ul class="text-3xl">
        ...
        <li><a href="/chattanooga/editorials/guild-hardy-trail-lookout-mountain">Guild-Hardy Trail: St. Elmo to Lookout</a></li>
        <li><a href="/chattanooga/editorials/shoreline-hike-at-booker-t-washington-state-park">Shoreline at Booker T. Washington</a></li>
