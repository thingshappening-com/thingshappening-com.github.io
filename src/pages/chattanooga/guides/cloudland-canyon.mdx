...
<div>
  <div class="pb-2 text-2xl">
    <div class="flex flex-col justify-center items-center mb-16 mt-16">
      <OptimizedImage loading="eager" src="/images/chattanooga_guides/outdoors/cloudland/vista.webp" alt="overlook of the canyon" />
    ...
    <div class="flex flex-col justify-center items-center mb-16 mt-16">
      <OptimizedImage src="/images/chattanooga_guides/outdoors/cloudland/trail-shot.webp" alt="West Rim and Overlook Trail fork" />
      <div class="text-center">
    ...
    <div class="flex flex-col justify-center items-center mb-16 mt-16">
      <OptimizedImage src="/images/chattanooga_guides/outdoors/cloudland/mtb-map.webp" alt="5 Points Trail Map" />
      <div class="text-center">
    ...
    <div class="flex flex-col justify-center items-center mb-16 mt-16">
        <OptimizedImage src="/images/chattanooga_guides/outdoors/cloudland/overlook-west-rim.webp" alt="West Rim and Overlook Trail fork" />
        <div class="text-center">
    ...
    <div class="flex flex-col justify-center items-center mb-16 mt-16">
      <OptimizedImage src="https://upload.wikimedia.org/wikipedia/commons/1/1b/Creekside_Disc_Golf_-_1023296199.jpg" alt="disc and target" />
      <div class="text-center">
        <em>
    ...
    <div class="flex flex-col justify-center items-center mb-16 mt-16">
      <OptimizedImage src="https://upload.wikimedia.org/wikipedia/commons/6/67/Series_of_Glamping_Yurts_near_Llansantffraed-in-Elwel%2C_Powys.jpg" alt="disc and target" />
      <div class="text-center">
        <em>
    ...
    <div class="flex flex-col justify-center items-center mb-16 mt-16">
      <OptimizedImage src="https://upload.wikimedia.org/wikipedia/commons/e/ec/Cloudland_Canyon_State_Park_%288648810088%29.jpg" alt="canyon waterfall" />
      <div class="text-center">
        <em>
