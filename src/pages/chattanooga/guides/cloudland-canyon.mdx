...
<div>
  <div class="pb-2 text-2xl">
    <div class="flex flex-col justify-center items-center mb-16 mt-16">
      <OptimizedImage src="/images/chattanooga_guides/outdoors/cloudland/vista.jpg" alt="overlook of the canyon" />
    ...
    <div class="flex flex-col justify-center items-center mb-16 mt-16">
      <OptimizedImage src="/images/chattanooga_guides/outdoors/cloudland/trail-shot.jpg" alt="West Rim and Overlook Trail fork" />
      <div class="text-center">
    ...
    <div class="flex flex-col justify-center items-center mb-16 mt-16">
      <OptimizedImage src="/images/chattanooga_guides/outdoors/cloudland/mtb-map.png" alt="5 Points Trail Map" />
      <div class="text-center">
    ...
    <div class="flex flex-col justify-center items-center mb-16 mt-16">
        <OptimizedImage src="/images/chattanooga_guides/outdoors/cloudland/overlook-west-rim.jpg" alt="West Rim and Overlook Trail fork" />
        <div class="text-center">
