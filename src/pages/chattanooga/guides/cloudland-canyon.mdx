...
description: "The ultimate guide to Cloudland Canyon State Park near Chattanooga—hiking, waterfalls, caves, mountain biking, camping, disc golf, and nearby restaurants, plus in-depth details on each."
---
import OptimizedImage from '../../../components/OptimizedImage.astro';

<div>
  <div class="pb-2 text-2xl pt-6">
    ...
    <section class="pb-10 text-xl2" id="advanced-hikes">
      <div>
