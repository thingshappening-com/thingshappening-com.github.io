...
<div>
  <div class="pb-2 text-2xl">
    ...
    <section class="text-2xl">
      <div class="pb-5">
        <h2 class="text-4xl">Chattanooga Campaign<span class="color-pink ml-1"><b>.</b></span></h2>
 ...
 <section class="pb-3 text-2xl" id="easier-hikes">
  ...
  <section class="pb-3 text-2xl">
    ...
    <div>
      <div class="pb-3">
        <div class="text-3xl"><span class="color-pink mr-2"><b>1.</b></span>Chicamauga Battlefield</div>
        <div>
          <b>
  ...
  <section class="pb-3 text-xl2">
    <div>
      <h2 class="text-5xl w-full break-words">Smaller Historical Sites<span class="color-pink ml-1"><b>.</b></span></h2>
    </div>
    <div>
      <div>
        <div class="mb-3">
