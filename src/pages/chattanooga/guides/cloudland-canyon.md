  ...
  <div class="pb-3 text-2xl" id="easier-hikes">
    ...
    <div>
      ...
      <div>
        ...
        <p>
          On this hike is an observation deck that offers a breathetaking view of the canyon vistas, be sure to stop and stare for a little while, maybe get a picture or maybe just store it in the old memory bank. In the summer there are blackberry bushes, with thousands of berries ripe for picking.
        </p>
      </div>
    </div>
    <br>
